    ...
    <div className='text-center'>
      ...
      <div className='container pt-3'>
        ...
        <div className='row pt-3'>
          <a className='col-sm-4' href='/shopping-cart/shop/#budweiser' title='Budwesier'>
            <img src={Budweiser}
              className='p-2'
              width='100%' 
              alt='Budweiser Logo'
          ...
          <a className='col-sm-4' href='/shopping-cart/shop/#busch' title='Buschhhhhhh'>
            <img src={Busch}
            className='p-2'
            width='100%' 
            alt='Busch Lite Logo'
          ...
          <a className='col-sm-4' href='/shopping-cart/shop/#corona' title='Corona Extra'>
            <img src={Corona}
            className='p-2'
            width='100%' 
            alt='Corona Logo'
        ...
        <a className='col-sm-4' href='/shopping-cart/shop/#michelob' title='Michelob Ultra'>
            <img src={Michelob}
            className='p-2'
            width='100%' 
          ...
          <a className='col-sm-4' href='/shopping-cart/shop/#natural' title='Natty Light'>
            <img src={Natural}
            className='p-2'
            width='100%' 
          ...
          <a className='col-sm-4' href='/shopping-cart/shop/#shocktop' title='Shock Top'>
            <img src={ShockTop}
            className='p-2'
            width='85%' 
            alt='Shock Top Logo'
